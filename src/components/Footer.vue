...
<template>
    <!-- component -->
    <footer class="relative py-20 flex flex-col items-center bg-primary overflow-hidden md:py-40">
            ...
            <div class="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
                <div class="flex flex-wrap items-center justify-between md:flex-nowrap">
                    ...
                    <div class="w-10/12 m-auto  mt-16 space-y-6 text-center sm:text-left sm:w-5/12 sm:mt-auto">
                        ...
                        <span class="block text-gray-300">Need help? <a href="#" class="font-semibold text-white"> Contact
                                Us</a></span>
                    </div>
                </div>
            </div>
        ...
        <div aria-hidden="true" class="absolute h-full inset-0 flex items-center">
            <div aria-hidden="true"
                class="bg-layers bg-scale w-56 h-56 m-auto blur-xl bg-gradient-to-r from-ff0060 via-ff0060 to-ff0060 rounded-full md:w-[30rem] md:h-[30rem] md:blur-3xl">
            </div>
        </div>
